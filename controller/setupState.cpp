...
const char * const LUA_LOCAL_PREP = "package.path = package.path..';./extlib/lua_path/?.lua;./model/?.lua;' package.cpath = package.cpath..';./extlib/lua_cpath/?.dll' require('state') require('util/state/start_game')";
